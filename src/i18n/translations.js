// Dictionnaire de traduction FR / EN pour tous les textes d'interface.
// Les données de projets (content.json) portent leur propre bloc "en".
export const translations = {
  fr: {
    ...
    footer: {
      ...
      follow: "Suivre",
      write: "Écrire",
      tagline: "Directeur artistique, Nice.",
    },
    nextStep: {
    ...
    about: {
      ...
      collaborateTitle: "Avec qui je collabore",
      servicesTitle: "Services",
    ...
    experience: [
      ...
      {
        role: "Design Manager",
        place: "Geometric El Djazair",
        dates: "2025 Jan. — 2025 Aoû.",
      },
      {
        role: "Designer Graphique",
        place: "Geometric El Djazair",
        dates: "2023 Jan. — 2024 Déc.",
      },
      {
        role: "Stagiaire en Design Graphique",
        place: "Geometric El Djazair",
        dates: "2022 Sep. — 2022 Déc.",
      },
    ],
    methodology: [
      {
  ...
  en: {
    ...
    about: {
      ...
      collaborateTitle: "Who I work with",
      servicesTitle: "Services",
    ...
    contact: {
      ...
      errorBody: "Please try again, or email me directly at dernouniamine02@gmail.com.",
    ...
    experience: [
      { role: "Co-founder", place: "Pulpp", dates: "Sep. 2025 — Present" },
      { role: "Art Director", place: "Freelance", dates: "Sep. 2025 — Present" },
      {
        role: "Design Manager",
        place: "Geometric El Djazair",
